...
<img width="100%" src="./assets/profile-hero-clean.svg" alt="Melad Samuel — Software Engineer, Cloud Native, Product Builder" />
...
<table>
  <tr>
    ...
    <td width="38%" valign="top">
      <h3>Product Card</h3>
      <table>
        <tr><td><strong>Category</strong></td><td>WordPress Plugin</td></tr>
        <tr><td><strong>Interface</strong></td><td>Modern Admin Dashboard</td></tr>
        <tr><td><strong>Backend</strong></td><td>PHP + REST API</td></tr>
        <tr><td><strong>Frontend</strong></td><td>React</td></tr>
        <tr><td><strong>Status</strong></td><td>Open Source</td></tr>
      </table>
    </td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%" valign="top">
      <h3>Kubernetes / CNCF</h3>
      <p>✅ Certified Kubernetes Administrator — <strong>CKA</strong></p>
      <p>✅ Certified Kubernetes Security Specialist — <strong>CKS</strong></p>
      <p>✅ Kubernetes and Cloud Native Associate — <strong>KCNA</strong></p>
      <p>✅ Kubernetes and Cloud Security Associate — <strong>KCSA</strong></p>
    </td>
    <td width="50%" valign="top">
      <h3>AWS</h3>
